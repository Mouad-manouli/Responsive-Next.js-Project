                ...
                <div className="w-full h-full bg-customBlue flex flex-row rounded-3xl">
                    <div className="w-[42%] p-5 pl-8 hidden md:block">
                        <div className="w-full ">
                            ...
                            <h1 className="text-[18px] lg:text-[25px] xl:text-[33px] text-white leading-10 font-semibold">Expert Maintenance for Smooth Operations.</h1>
                            <div className="w-full flex items-center justify-center">
                                <Image src={'/images/login5.png'} alt="image" width={220} height={210} className=" w-[200px] h-[250px] xl:w-[220px] xl:h-[270px]"/>
                            </div>
                        </div>
                    </div>
                    <div className="w-full md:w-[58%] bg-white rounded-3xl px-8 sm:px-14 py-12 shadow-[0_5px_25px_rgba(1,1,1,0.15)]">
                        ...
                        <h1 className="font-semibold mt-10 mb-3 text-3xl  md:text-2xl lg:text-3xl ">Login</h1>
                        <form action="">
                            ...
                            <button className="bg-[#2A4451] w-full border-none p-2.5 text-white rounded-[20px] mt-8 mb-7">Login</button>
                        </form>
                        <div className="pb-5 pt-2 flex items-center justify-center ">
                            <div className="flex-grow h-px bg-gray-300"></div>
                            <p className="text-gray-400 mx-5">Or login with</p>
                            <div className="flex-grow h-px bg-gray-300"></div>
                        </div>
                        <div className="w-full flex items-center justify-center">
                        ...
                        <div className="w-full flex items-center justify-center">
                            <div className="flex flex-row mt-4">
                                <p className="text-[#9EAAB5] mr-[10px] sm:mr-[20px] text-sm sm:text-base">Don't have an account</p>
                                <Link href="/auth/signup" className="text-[#2A4451] text-sm sm:text-base">Sign up</Link>  
                            </div>
                        </div>
                    </div>
                </div>
